    ...
    <AppLayout>
      ...
      <div className="mb-6 flex flex-wrap items-center gap-3">
        ...
        <label className="flex cursor-pointer items-center gap-2 rounded-xl border border-border bg-surface/60 px-3 py-2.5 text-sm">
          ...
          <select aria-label="Sort genres by" value={sort} onChange={(e) => setSort(e.target.value as GenreSort)} className="cursor-pointer bg-transparent text-sm outline-none">
